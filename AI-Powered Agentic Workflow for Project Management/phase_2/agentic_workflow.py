...
# Workflow Prompt
# ****
# FIX: Broaden the workflow prompt to capture the entire project scope
workflow_prompt = "Create a comprehensive project plan for the Email Router, including user stories, product features, and development tasks."
# ****
